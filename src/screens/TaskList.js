...
//moment -> pega o horario
import moment from 'moment'
//traduz para pt br o horario
...
export default class TaskList extends Component {
    ...
    //metodod de clico de vida (componente ja montado)
    ...
    //Alternancia da verificacao das tasks
    toggleTask = (taskId) => {
    ...
    deleteTask = (id) => {
        //atraves do filter sera gerado um outro vetor
    ...
    render() {
        ...
        return (
            //<FlatList data={this.state.tasks} keyExtractor={(item) => `${item.id}`} renderItem={({ item }) => <Task {...item} />} /> -> Adicinar Scroll atraves da flatlistm keyextractor para defininir
            //o id do item e render para "passar" os itens para o component task ...item -> operador spread (Aula 109 adicionar flatlist)
...
const styles = StyleSheet.create({
    // Flex: porcentagem que cada conteudo vai ocupar na tela
    container: {
    ...
    iconBar: {
        ...
        marginHorizontal: 20,
        justifyContent: 'flex-end',
        //verificação de ios, para ajustar a margin top
